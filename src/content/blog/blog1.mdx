...
<h1 className={`text-2xl font-medium !leading-[30.72px] text-red-400 ${style}`}>
  Understanding the global context of street children helps readers grasp the
  importance of these stories:
</h1>

<CustomImage src="/images/article1.png" width={400} height={400} alt="img" />

<Heading3 title="dhruv" />
